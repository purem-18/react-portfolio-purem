...
// import logo from "../assets/puremLogo.png";
...
//         {/* Navigation links */}
//         <div className={`w-full md:w-auto md:flex ${isOpen ? 'block' : 'hidden'} ${isOpen ? 'bg-neutral-900 bg-opacity-90' : ''} md:bg-transparent`}>
//           <button onClick={() => scrollToSection('hero')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 mr-4 py-2 px-4 md:p-0">Home</button>
//           <button onClick={() => scrollToSection('about')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 mr-4 py-2 px-4 md:p-0">About</button>
//           <button onClick={() => scrollToSection('technologies')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 mr-4 py-2 px-4 md:p-0">Technologies</button>
//           <button onClick={() => scrollToSection('experience')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 mr-4 py-2 px-4 md:p-0">Experience</button>
//           <button onClick={() => scrollToSection('projects')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 mr-4 py-2 px-4 md:p-0">Projects</button>
//           <button onClick={() => scrollToSection('contact')} className="block w-full text-left md:inline-block md:w-auto mt-4 md:mt-0 text-white hover:text-gray-300 py-2 px-4 md:p-0">Contact</button>
//         </div>

//         {/* Social media links */}
//         <div className="hidden md:flex items-center justify-center gap-4 text-2xl">
//           <a href='https://www.linkedin.com/in/puremba-moirangthem-ba4981204' target="_blank" rel="noopener noreferrer">
//             <FaLinkedin />
//           </a>
//           <a href='https://github.com/purem-18' target="_blank" rel="noopener noreferrer">
//             <FaGithub />
//           </a>
//           <a href='https://x.com/puremba_m' target="_blank" rel="noopener noreferrer">
//             <FaSquareXTwitter />
//           </a>
